...
import companyLogo from "../assets/algo_cirrus.png";
import companyLogo1 from "../assets/maq_software.png";
import companyLogo2 from "../assets/microsoft.png";
      ...
      <div className='container  2xl:px-20 mx-auto my-10'>
        ...
        <div className='border border-[#CFCFCF] shadow-md mx-2 mt-5 p-6 rounded-md flex flex-col sm:flex-row sm:items-center'>
          ...
          <div className='flex flex-wrap justify-center gap-4 lg:gap-20 flex-grow'>
            <img
              className='h-[60px] w-[120px] grayscale hover:grayscale-0 transition-all duration-300'
              src={companyLogo}
              alt='Logo 1'
            />
            <img
              className='h-[50px] w-[170px] grayscale hover:grayscale-0 transition-all duration-300'
              src={companyLogo1}
              alt='Logo 2'
            />
            <img
              className='h-[50px] w-[150px] grayscale hover:grayscale-0 transition-all duration-300'
              src={companyLogo2}
              alt='Logo 3'
            />
            <img
              className='h-[70px] w-[120px] grayscale hover:grayscale-0 transition-all duration-300'
              src={companyLogo3}
              alt='Logo 4'
            />
            {/* <img
            ...
            /> */}
            <img
              className='h-[50px] w-[70px] grayscale hover:grayscale-0 transition-all duration-300'
              src={companyLogo5}
              alt='Logo 6'
            />
          </div>
