    ...
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
      ...
      <div className='w-full lg:w-1/4 bg-white px-4'>
        {isSearched &&
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              <h3 className='font-bold text-larger mb-4 font-primary'>
                Current Search
              </h3>
        ...
        <div className={showFilter ? "" : "hidden lg:block"}>
          <h4 className='font-semibold text-larger py-6 font-primary'>
      ...
      <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
        ...
        <div className='relative min-h-[600px]'>
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 transition-opacity duration-300 ${
